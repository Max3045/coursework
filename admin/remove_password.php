...
<form class="formReg" action="remove.php" method="POST">
        <label style="color:#c0cafa;">Имя<span class="form-required" title="Обязательно для заполнения.">*</span></label>
        ...
        <button title="submit">Сменить пароль</button>
        <?php
